...
tests :: [Test]
tests = [ testCase "while/transform/extended-to-strict/renaming1" testStrictRenaming1
        , testCase "while/transform/extended-to-strict/renaming2" testStrictRenaming2
        , testCase "while/transform/extended-to-strict/renaming3" testStrictRenaming3
        , testCase "while/transform/extended-to-strict/assignment1" testStrictAssignment1
        , testCase "while/transform/extended-to-strict/assignment2" testStrictAssignment2
        , testCase "while/transform/extended-to-strict/arithmetic1" testStrictArithmetic1
        , testCase "while/transform/extended-to-strict/arithmetic2" testStrictArithmetic2
        {-, testCase "while/transform/extended-to-strict/arithmetic3" testStrictArithmetic3-}
        {-, testCase "while/transform/extended-to-strict/arithmetic4" testStrictArithmetic4-}
        {-, testCase "while/transform/extended-to-strict/arithmetic5" testStrictArithmetic5-}
        , testCase "while/transform/extended-to-strict/arithmetic6" testStrictArithmetic6
        , testCase "while/transform/extended-to-strict/arithmetic7" testStrictArithmetic7
        , testCase "while/transform/extended-to-strict/arithmetic8" testStrictArithmetic8
        , testCase "while/transform/extended-to-strict/control1" testStrictControl1
        {-, testCase "while/transform/extended-to-strict/control2" testStrictControl2-}
        {-, testCase "while/transform/extended-to-strict/control3" testStrictControl3-}
        {-, testCase "while/transform/extended-to-strict/control4" testStrictControl4-}
        {-, testCase "while/transform/extended-to-strict/control5" testStrictControl5-}
        {-, testCase "while/transform/extended-to-strict/control6" testStrictControl6-}
        {-, testCase "while/transform/extended-to-strict/control7" testStrictControl7-}
        {-, testCase "while/transform/extended-to-strict/control8" testStrictControl8-}
        , testCase "while/transform/extended-to-strict/control9" testStrictControl9
        , testCase "while/transform/extended-to-strict/control10" testStrictControl10
        , testCase "while/transform/extended-to-strict/control11" testStrictControl11
        , testCase "while/transform/extended-to-strict/control12" testStrictControl12
        , testCase "while/transform/extended-to-strict/control13" testStrictControl13
        , testCase "while/transform/extended-to-strict/control14" testStrictControl14
        , testCase "while/transform/extended-to-strict/control15" testStrictControl15
        , testCase "while/transform/extended-to-strict/control16" testStrictControl16
        , testCase "while/transform/extended-to-strict/control17" testStrictControl17
        ]

-- TODO: If I could somehow reduce the code duplication use common code for all
-- three languages to transform them to their strict subset, I would only need
-- to test the transformation of a "for loop" to a while loop and the
-- transformation of a while to with an arbitrary boolean expression to a while
